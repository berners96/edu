		...
		<div class="inner">
			<form id="frm">
				<table width="100%" class="table02">
					...
					<tbody id="tbody">
						<tr>
							...
							<td><input type="text" id="boardSubject" name="boardSubject" class="tbox01" /></td>
						</tr>
						<tr>
							<th>작성자<span class="t_red">*</span></th>
							<td><input type="text" id="boardWriter" name="boardWriter" class="tbox01" /></td>
						</tr>
						<tr>
				...
				<div class="btn_right mt15">
					...
					<button type="button" class="btn blakc" id="write">등록하기</button>
				</div>
			</form>
		</div>
	</div>
